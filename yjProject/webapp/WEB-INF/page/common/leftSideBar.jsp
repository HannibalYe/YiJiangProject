		...
		<ul>
			<li> 
				...
				<a href="#">
					...
					<span class="menu-item-parent">画廊相册管理</span>
				</a>
				<ul>
					<li class="
						<c:choose>
			...
			<li class="<c:if test="${fn:startsWith(fn:substringAfter(uri,base), '/home/team')}">active</c:if>">
				<a href="${base}/home/user">
					<i class="fa fa-lg fa-fw fa-user"></i> 
					<span class="menu-item-parent">我的团队管理</span>
				</a>
			</li>
			<li class="<c:if test="${fn:startsWith(fn:substringAfter(uri,base), '/home/user')}">active</c:if>">
				<a href="${base}/home/user">
					<i class="fa fa-lg fa-fw fa-user"></i> 
					<span class="menu-item-parent">帐号管理</span>
				</a>
			</li>
