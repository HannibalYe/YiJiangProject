    ...
    $.extend(ChromaScreen.prototype,
    {
            ...
            (
                "<div class='chroma-screen'><div class='chrg-bg'></div>"+
                    "<div class='chrg-wrap'>"+
                        ...
                        "<div class='chrg-ui'>"+
                            "<button class='chrgi-close chrg-no-select'><i class='fa fa-close fa-md'></i></button>"+
                            "<button class='chrg-fullscreen chrgi-maximize chrg-no-select'><i class='fa fa-expand fa-md'></i></button>"+
                            "<button class='chrgi-next chrg-no-select'><i class='fa fa-angle-right fa-lg'></i></button>"+
                            "<button class='chrgi-previous chrg-no-select'><i class='fa fa-angle-left fa-lg'></i></button>"+
        ...
        toggleFullscreen:function()
        {
            ...
            if (!document.fullscreenElement && !document.mozFullScreenElement && !document.webkitFullscreenElement && !document.msFullscreenElement) 
            {
                ...
                this.$fullscreenBtn.html("<i class='fa fa-compress fa-md'></i>");
            ...
            else 
            {
				...
				this.$fullscreenBtn.html("<i class='fa fa-expand fa-md'></i>");
                //Cross browser implementations
